  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-4 gap-6 w-full text-left bg-slate-50 dark:bg-slate-950 transition-colors duration-200 font-sans pb-12 select-none">
      ...
      <div className="xl:col-span-3 flex flex-col gap-6">
        ...
        <div className="relative overflow-hidden bg-gradient-to-r from-slate-900 via-slate-900 to-slate-950 dark:from-slate-900 dark:via-slate-950 dark:to-black border border-slate-800 rounded-3xl p-6 sm:p-8 text-white shadow-xl">
          {/* Subtle Background Glows */}
          <div className="absolute top-0 right-0 w-80 h-80 bg-[#04AA6D]/15 rounded-full blur-[90px] pointer-events-none" />
          <div className="absolute bottom-0 left-1/3 w-60 h-60 bg-indigo-500/10 rounded-full blur-[80px] pointer-events-none" />

          <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div>
              <div className="flex items-center gap-2.5 mb-2">
                <span className="px-3 py-1 rounded-full text-[10px] font-bold font-mono bg-[#04AA6D]/20 text-emerald-400 border border-[#04AA6D]/40 uppercase tracking-widest flex items-center gap-1.5">
                  <Sparkles size={12} />
            ...
            <div className="flex items-center gap-3 shrink-0">
              ...
              <Link
                to="/learning"
                className="flex items-center gap-2 px-5 py-3 bg-[#04AA6D] hover:bg-emerald-600 text-white text-xs font-mono font-bold rounded-2xl transition-all cursor-pointer shadow-lg shadow-emerald-950/40 border border-emerald-500/30"
              >
                <BookOpen size={15} />
        ...
        <div className="bg-gradient-to-r from-emerald-950/40 via-slate-900 to-indigo-950/40 border border-emerald-500/30 rounded-3xl p-6 shadow-md flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div className="flex items-center gap-4 flex-1">
            <div className="w-14 h-14 rounded-2xl bg-[#04AA6D]/20 border border-[#04AA6D]/40 text-[#04AA6D] flex items-center justify-center shrink-0 font-mono font-black text-xl shadow-inner">
              &lt;/&gt;
            </div>
            <div className="min-w-0">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xs font-mono text-slate-400 font-bold">{activePath.completionPercentage || 0}% Complete</span>
              </div>
              <h3 className="text-base font-black text-white truncate font-mono">
                {activePath.title}
              </h3>
          ...
          <Link
            ...
            className="flex items-center gap-2 px-6 py-3 bg-[#04AA6D] hover:bg-emerald-600 text-white font-mono font-bold text-xs rounded-2xl transition-all shadow-md shrink-0 border border-emerald-400/30"
          >
