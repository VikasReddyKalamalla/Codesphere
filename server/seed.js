...
async function seed() {
  ...
  const pdfSampleUrl = 'https://raw.githubusercontent.com/mozilla/pdf.js/master/web/compressed.tracemonkey-pldi-09.pdf';
  ...
  await Resource.insertMany([
    // Full Stack & Web Dev
    {
      ...
      externalUrl: pdfSampleUrl, uploadedBy: sarah._id, status: 'published',
    ...
    // DSA & Algorithms
    {
      ...
      externalUrl: pdfSampleUrl, uploadedBy: james._id, status: 'published',
    ...
    // Cloud & DevOps
    {
      ...
      externalUrl: pdfSampleUrl, uploadedBy: vikas._id, status: 'published',
