...
async function seed() {
  ...
  await Resource.insertMany([
    // Full Stack & Web Dev
    {
      ...
      externalUrl: pdfUrls.jsCheatsheet, uploadedBy: sarah._id, status: 'published',
    ...
    },
    {
      ...
      resourceType: 'video', category: resCats[0]._id, difficulty: 'intermediate', language: 'English',
      externalUrl: 'https://www.youtube.com/watch?v=8aGhZQkoFbQ', uploadedBy: sarah._id, status: 'published',
    ...
    },
    {
      ...
      description: 'Deep dive into Server Components, Server Actions, Suspense boundaries, streaming, and state management in React.',
      resourceType: 'pdf', category: resCats[0]._id, difficulty: 'advanced', language: 'English',
      externalUrl: pdfUrls.reactNotes, uploadedBy: sarah._id, status: 'published',
    ...
    },
    {
      ...
      externalUrl: 'https://github.com/facebook/react', uploadedBy: sarah._id, status: 'published',
    ...
    },
    {
      ...
      resourceType: 'pdf', category: resCats[0]._id, difficulty: 'beginner', language: 'English',
      externalUrl: pdfUrls.cssGrid, uploadedBy: sarah._id, status: 'published',
    ...
    // DSA & Algorithms
    {
      ...
      externalUrl: pdfUrls.bigO, uploadedBy: james._id, status: 'published',
    ...
    },
    {
      ...
      externalUrl: pdfUrls.leetcode, uploadedBy: james._id, status: 'published',
    ...
    },
    {
      ...
      resourceType: 'video', category: resCats[1]._id, difficulty: 'advanced', language: 'English',
      externalUrl: 'https://www.youtube.com/watch?v=oBt53YbR9Kk', uploadedBy: james._id, status: 'published',
    ...
    },
    {
      ...
      resourceType: 'pdf', category: resCats[1]._id, difficulty: 'intermediate', language: 'English',
      externalUrl: pdfUrls.graphAlgo, uploadedBy: james._id, status: 'published',
    ...
    // AI, ML & Data Science
    {
      ...
      externalUrl: pdfUrls.pandas, uploadedBy: james._id, status: 'published',
    ...
    },
    {
      ...
      externalUrl: pdfUrls.pytorch, uploadedBy: james._id, status: 'published',
    ...
    },
    {
      ...
      externalUrl: 'https://github.com/hwchase17/langchain', uploadedBy: james._id, status: 'published',
    ...
    // System Design
    {
      ...
      externalUrl: pdfUrls.sysDesign, uploadedBy: sarah._id, status: 'published',
    ...
    },
    {
      ...
      resourceType: 'video', category: resCats[3]._id, difficulty: 'advanced', language: 'English',
      externalUrl: 'https://www.youtube.com/watch?v=b4b8ktEV4Bg', uploadedBy: sarah._id, status: 'published',
    ...
    // Cloud & DevOps
    {
      ...
      externalUrl: pdfUrls.docker, uploadedBy: vikas._id, status: 'published',
    ...
    },
    {
      ...
      resourceType: 'pdf', category: resCats[4]._id, difficulty: 'advanced', language: 'English',
      externalUrl: pdfUrls.k8s, uploadedBy: vikas._id, status: 'published',
    ...
    },
    {
      ...
      resourceType: 'pdf', category: resCats[4]._id, difficulty: 'intermediate', language: 'English',
      externalUrl: pdfUrls.aws, uploadedBy: vikas._id, status: 'published',
    ...
    // Cyber Security
    {
      ...
      externalUrl: pdfUrls.owasp, uploadedBy: sarah._id, status: 'published',
    ...
    },
    {
      ...
      resourceType: 'pdf', category: resCats[5]._id, difficulty: 'intermediate', language: 'English',
      externalUrl: pdfUrls.networkSec, uploadedBy: sarah._id, status: 'published',
    ...
    // Interview & Placement
    {
      ...
      externalUrl: pdfUrls.interview, uploadedBy: sarah._id, status: 'published',
    ...
    // General CS
    {
      ...
      resourceType: 'pdf', category: resCats[7]._id, difficulty: 'intermediate', language: 'English',
      externalUrl: pdfUrls.sql, uploadedBy: james._id, status: 'published',
      views: 370, downloadsCount: 195, averageRating: 4.8,
      tags: ['sql', 'database', 'postgresql', 'indexing', 'general-cs'],
    },
  ]);
  console.log('✓ Seeded 8 resource categories and 21 developer resources with valid PDF/Video URLs');
